document.addEventListener('DOMContentLoaded', () => {
    const socket = io('https://zutomayosong.site');
    ...
    document.getElementById('createRoomForm').addEventListener('submit', (e) => {
        ...
        fetch('https://zutomayosong.site/create-room', {
            method: 'POST',
            headers: {
    ...
    document.getElementById('room-list').addEventListener('click', (event) => {
        if (event.target.classList.contains('join-room-btn')) {
            ...
            window.location.href = `http://zutomayosong.site/app/song/room.html?roomId=${roomId}`;
        }
    });
    ...
    fetch('https://zutomayosong.site/images')
        .then(response => response.json())
        .then(images => {
            ...
            if (Array.isArray(images)) {
                images.forEach(image => {
                    ...
                    imgElement.src = `https://zutomayosong.site/images/${image}`;
